# Generated by Django 4.2.9 on 2025-10-29 06:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Silabo',
            fields=[
                ('curso', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='silabo', serialize=False, to='app.curso')),
                ('archivo_pdf', models.FileField(blank=True, null=True, upload_to='silabos/', verbose_name='Archivo PDF del sílabo')),
            ],
            options={
                'verbose_name': 'Sílabo',
        ...
        migrations.AddField(
            model_name='profesor',
            name='tipo_profesor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.tipoprofesor'),
        ),
        migrations.AddField(
            model_name='profesor',
            name='usuario',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profesor', to='app.usuario'),
        ),
        migrations.CreateModel(
            name='Nota',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(choices=[('Primer Parcial', 'Primer Parcial'), ('Segundo Parcial', 'Segundo Parcial'), ('Tercer Parcial', 'Tercer Parcial')], max_length=100, verbose_name='Tipo de Examen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='accesos_profesor', to='app.curso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.BooleanField(default=True)),
                ('silabo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contenidos', to='app.silabo')),
            ],
            options={
